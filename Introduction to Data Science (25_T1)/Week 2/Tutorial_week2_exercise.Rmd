...
Write a function compute_s_n that for any given n computes the sum Sn = 1^2 + 2^2 +
3^2 + . . . n^2. Report the value of the sum when n = 10.
...
- Then, add two columns, "GDP_growth_rate" and "weeklyWageLevel", using `mutate` to show yearly GDP growth rate and if weekly wage level was over £500 or not. 
```{r Exercise 1}
